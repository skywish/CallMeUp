...
public class ChangeCityActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToolbarWithBack("修改地区");
        loadSpinner();
        btn_save = (Button) findViewById(R.id.btn_save);
        btn_save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                location = display.getText().toString();
                if (!location.isEmpty()) {
                    updateUser.setCity(location);
                    updateUser.update(ChangeCityActivity.this, new UpdateListener() {
                        @Override
    ...
    private void loadSpinner() {
        display = (TextView) findViewById(R.id.tv_location);
