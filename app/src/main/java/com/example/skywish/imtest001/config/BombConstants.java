package com.example.skywish.imtest001.config;
...
public class BombConstants {
     ...
     * 存放发送图片的目录
     */
    public static String BMOB_PICTURE_PATH = Environment.getExternalStorageDirectory()
            + "/CallMeUpTest/image/";

    /**
     * 我的头像保存目录
     */
    public static String MyAvatarDir = "/sdcard/CallMeUpTest/avatar/";
    /**
     * 拍照回调
     */
    ...
    public static final String ACTION_CHAT_FINISH ="chat.success.finish";
}
